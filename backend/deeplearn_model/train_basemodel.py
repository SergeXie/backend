...
#     train_model(df, distribution=[-10, -8, -6, -4, -2, 10, 8, 6, 4, 2], model_path='FPG-XAUUSD_M15')
...
#     train_model(df, distribution=[-30, -20, -10, -5, -3, 30, 20, 10, 5, 3], model_path='FPG-XAUUSD_M30')
    ...
    # train_model(df, distribution=[-30,-20,-10,-5,-3,30,20,10,5,3], model_path='FPG-XAUUSD_H4')
