...
from core.bt.indicators.bb_trend import ResponseBBTrendData
from core.bt.indicators.acp import ResponseACPData
from core.bt.indicators.bollinger import ResponseBollingerData
from core.bt.indicators.btatr import ResponseATRData
from core.bt.indicators.cci import ResponseCCIData
from core.bt.indicators.dma import ResponseDMAData
from core.bt.indicators.ema import ResponseEMAData
from core.bt.indicators.ma import ResponseMAMovingAverageIndicator
from core.bt.indicators.macd import ResponseMACDData
from core.bt.indicators.macd_v1 import ResponseMACDData_v1
from core.bt.indicators.packconnection_v2 import ResponsePCDataV2
from core.bt.indicators.rsi import ResponseRSIData
from core.bt.indicators.smcp import ResponseSMCPData
from core.bt.indicators.wm import ResponseWMData
from core.bt.indicators.wm_picture import ResponseWMPicyureData
from core.bt.indicators.wm_predict_bymath import ResWMpredictByMathData
from core.bt.indicators.wm_predict_bymodel import ResWMpredictByModelData
from database.db_mysql import async_db_session
from core.bt.indicators.wm_sub import WMSubPatternIndicator
from core.bt.indicators import ResponsePCData, ResponseATRStopLossData
from pypinyin import lazy_pinyin, Style
from typing import List, Dict, Any
from core.bt.strategys import reload_strategies
from core.bt.strategys.peak_trough_strategy import ResponsePeakTroughData
from schemas.base import TradingFPG, DqlGoods, DqlIndicators, DqlStrategy, DqlOrder
from utils.timezone import timezone
from dateutil import parser
from core.bt.base.public_strategy import ComprehensiveAnalyzer
from schemas.base import TradingFPG,TradingFPGFx,TradingFPG2,TradingBRC5,TradingOnda,TradingFXTM5,TradingIndex,TradingIndex2,TradingY20
...
model_classes = {
    ...
    'dql_trading_fpg_fx': TradingFPGFx,
...
def datetimesp(dt_float):
    # 将浮点数转换为日期时间格式
    dt_datetime = datetime.fromordinal(int(dt_float)) + datetime.timedelta(days=dt_float % 1)
