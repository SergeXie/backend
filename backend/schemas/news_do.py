...
class MarketStatistics(Base):
    ...
    m5: Mapped[str | None] = mapped_column(String(255), nullable=True, comment="公布后5分钟走势 开高低收")
    m30: Mapped[str | None] = mapped_column(String(255), nullable=True, comment="公布后30分钟走势 开高低收")
    h1: Mapped[str | None] = mapped_column(String(255), nullable=True, comment="公布后1小时走势 开高低收")
    d1: Mapped[str | None] = mapped_column(String(255), nullable=True, comment="公布后1天走势 开高低收")
    w1: Mapped[str | None] = mapped_column(String(255), nullable=True, comment="公布后1周走势 开高低收")
